...
class TSSTG(object):
    ...
    def __init__(self,
        ...
        self.model = TwoStreamSpatialTemporalGraph(self.graph_args, self.num_class).to(self.device)     # stgcn初始化
        self.model.load_state_dict(torch.load(weight_file))     # 载入权重文件
        self.model.eval()       # 防止权重被修改
